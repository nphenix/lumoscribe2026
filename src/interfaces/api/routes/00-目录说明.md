...
| `outline.py` | 大纲接口（润色/保存）T062 | 2026-01-26 |
| `generate.py` | 内容生成接口（触发/进度）T096 | 2026-01-27 |

## 更新日志

| 日期 | 操作 | 文件 | 说明 |
|------|------|------|------|
| 2026-01-27 | 新增 | `generate.py` | 添加内容生成接口 T096 |
| 2026-01-26 | 新增 | `outline.py` | 添加大纲润色/保存接口 T062 |
