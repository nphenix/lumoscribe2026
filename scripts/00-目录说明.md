...
| `clean_mineru_data.py` | MinerU 数据清理脚本（清除 source_files、ingest jobs 和 mineru_raw 产物，用于重置测试环境） | 2026-01-23 |
| `check_cleaning_data.py` | 检查文档清洗数据状态（IntermediateArtifacts、SourceFile、物理目录） | 2026-01-24 |
| `clean_cleaned_docs.py` | 清理文档清洗中间产物（数据库记录 + 物理文件，支持旧数据清理） | 2026-01-24 |
| `check_kb_status.py` | 检查知识库建设状态（验证向量库 chunks 数量、BM25 索引、源文档对应关系） | 2026-01-26 |
| `t201-whitepaper-baseline.py` | T201：白皮书生成质量基线统计（HTML 重复率/空章节/图表锚点缺失等） | 2026-01-29 |
| `t202-chart-json-html-mapping.py` | T202：抽样导出 chart_id 在 HTML 中的章节位置，并反查 chart_json 路径 | 2026-01-29 |

## 更新日志

| 日期 | 操作 | 文件 | 说明 |
|------|------|------|------|
| 2026-01-29 | 新增 | `t201-whitepaper-baseline.py` | 添加白皮书生成质量基线统计脚本 |
| 2026-01-29 | 新增 | `t202-chart-json-html-mapping.py` | 添加 chart_json 与 HTML 图表位置抽样导出脚本 |
| 2026-01-26 | 新增 | `check_kb_status.py` | 添加知识库建设状态检查脚本 |
| 2026-01-24 | 新增 | `clean_cleaned_docs.py` | 添加文档清洗产物清理脚本 |
| 2026-01-24 | 新增 | `check_cleaning_data.py` | 添加文档清洗数据检查脚本 |
| 2026-01-23 | 新增 | `clean_mineru_data.py` | 添加 MinerU 脏数据清理脚本 |
